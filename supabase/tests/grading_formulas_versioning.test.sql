...
select has_index('public','grading_formula_assignments','grading_formula_assignment_cycle_active_idx','une formule active par cycle');
select has_index('public','grading_formula_assignments','grading_formula_assignment_level_active_idx','une formule active par niveau');
