...
export function AddGuardianDialog({
  ...
  const save = async () => {
    ...
    try {
      ...
      if (selected) await linkGuardian({ ...common, guardianId: selected.id });
      else {
        if (
          !form.firstName.trim() ||
          !form.lastName.trim() ||
      ...
      setFailure(
        "Vérifiez les informations ou si ce responsable est déjà lié.",
      );
    } finally {
      setBusy(false);
    }
  ...
  return (
    ...
    >
      ...
      <div className="dialog-actions">
        ...
        <Button
          label={selected ? "Lier ce responsable" : "Créer et lier"}
