...
export const enrollmentSchema = z.object({
  ...
  guardianFirstName: z.string().trim().min(1, "Le prénom du responsable est obligatoire"),
  guardianLastName: z.string().trim().min(1, "Le nom du responsable est obligatoire"),
