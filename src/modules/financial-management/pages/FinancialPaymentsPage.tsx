  ...
  return (
    <div className="space-y-4 pb-8">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3"><div><h2 className="text-base font-semibold text-slate-950">Vue de caisse</h2><p className="mt-1 text-sm text-slate-500">Synthèse de l’activité financière de l’année.</p></div><span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-600">{year.name}</span></div>
