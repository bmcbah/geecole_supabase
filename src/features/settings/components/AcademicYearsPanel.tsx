  ...
  return (
    <section>
      ...
      <TablePanel
        ...
        description="Préparez l’année, ouvrez-la pour les opérations courantes, puis clôturez-la."
        meta={<Tag value={`${items.length} année${items.length > 1 ? "s" : ""}`} severity="secondary" />}
        toolbar={
          <>
            <TableSearch
              value={search}
