...
export const navigation: NavigationGroup[] = [
  {
    ...
    items: [
      ...
      { type: "link", label: "Admissions et inscriptions", icon: "pi-inbox", to: "/scolarite/admissions" },
      ...
      { type: "link", label: "Classes et affectations", icon: "pi-building", to: "/scolarite/classes" },
      { type: "link", label: "Responsables", icon: "pi-address-book", to: "/scolarite/responsables" },
      { type: "link", label: "Documents obligatoires", icon: "pi-folder-open", to: "/scolarite/documents" },
      { type: "link", label: "Imports", icon: "pi-upload", to: "/scolarite/imports" },
      { type: "link", label: "Attestations", icon: "pi-file-pdf", to: "/scolarite/attestations" },
      { type: "divider" },
      { type: "title", label: "Vie scolaire" },
