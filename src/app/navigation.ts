...
export const navigation: NavigationGroup[] = [
  ...
  },
  {
    ...
    to: "/gestion-financiere/pilotage",
    items: [
      { type: "title", label: "Pilotage" },
      { type: "link", label: "Vue d’ensemble", icon: "pi-chart-bar", to: "/gestion-financiere/pilotage" },
      { type: "link", label: "Échéances et recouvrement", icon: "pi-calendar-clock", to: "/gestion-financiere/echeances" },
      { type: "divider" },
      { type: "title", label: "Gestion" },
