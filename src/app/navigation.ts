...
export const navigation: NavigationGroup[] = [
  ...
  },
  {
    ...
    to: "/gestion-financiere/travail",
    items: [
      { type: "title", label: "Travail quotidien" },
      { type: "link", label: "Mon travail", icon: "pi-check-square", to: "/gestion-financiere/travail" },
      { type: "link", label: "Encaisser", icon: "pi-wallet", to: "/gestion-financiere/dossiers" },
      { type: "link", label: "Échéances à traiter", icon: "pi-calendar-clock", to: "/gestion-financiere/echeances" },
      { type: "link", label: "Situations familles", icon: "pi-users", to: "/gestion-financiere/familles" },
      { type: "divider" },
      { type: "title", label: "Contrôle" },
      { type: "link", label: "Dossiers financiers", icon: "pi-folder", to: "/gestion-financiere/dossiers" },
      { type: "link", label: "Journal et reçus", icon: "pi-history", to: "/gestion-financiere/encaissements" },
      { type: "link", label: "Vue de pilotage", icon: "pi-chart-bar", to: "/gestion-financiere/pilotage" },
      { type: "divider" },
      { type: "title", label: "Configuration" },
