...
const SchoolingCockpitPage = lazy(() =>
  import("../../modules/schooling/pages/SchoolingCockpitPage").then(
    (module) => ({ default: module.SchoolingCockpitPage }),
  ),
);
const InscriptionsWorkspacePage = lazy(() =>
  import("../../modules/schooling/pages/InscriptionsWorkspacePage").then(
    (module) => ({ default: module.InscriptionsWorkspacePage }),
  ),
);
const PreEnrollmentsWorkspacePage = lazy(() =>
  import("../../modules/schooling/pages/PreEnrollmentsWorkspacePage").then(
    (module) => ({ default: module.PreEnrollmentsWorkspacePage }),
  ),
);
const AttendanceWorkspacePage = lazy(() =>
  import("../../modules/schooling/pages/AttendanceWorkspacePage").then(
    (module) => ({ default: module.AttendanceWorkspacePage }),
  ),
);
const DocumentsWorkspacePage = lazy(() =>
  import("../../modules/schooling/pages/DocumentsWorkspacePage").then(
    (module) => ({ default: module.DocumentsWorkspacePage }),
  ),
);
const SchoolYearPreparationWorkspacePage = lazy(() =>
  import("../../modules/schooling/pages/SchoolYearPreparationWorkspacePage").then(
    (module) => ({ default: module.SchoolYearPreparationWorkspacePage }),
  ),
);
...
const EmployeeSanctionsPage = lazy(() =>
  import("../../modules/personnel/pages/EmployeeSanctionsPage").then(
    (module) => ({ default: module.EmployeeSanctionsPage }),
  ),
);
        ...
        <Route element={<ProtectedRoute />}>
          ...
          >
            ...
            <Route
              ...
              element={<InscriptionsWorkspacePage />}
            />
            <Route
              path="/scolarite/preinscriptions"
              element={<PreEnrollmentsWorkspacePage />}
            />
            <Route
              path="/scolarite/admissions"
              element={<Navigate to="/scolarite/inscriptions" replace />}
            />
            <Route
              path="/scolarite/assiduite"
              element={<AttendanceWorkspacePage />}
            />
            <Route
            ...
            />
            <Route
              path="/scolarite/preparation-rentree"
              element={<SchoolYearPreparationWorkspacePage />}
            />
            <Route
            ...
            <Route
              ...
              element={<Navigate to="/scolarite/preparation-rentree" replace />}
            />
            <Route
              path="/scolarite/responsables"
              element={<Navigate to="/scolarite/eleves" replace />}
            />
            <Route
              path="/scolarite/imports"
              element={<Navigate to="/scolarite/eleves" replace />}
            />
            <Route
