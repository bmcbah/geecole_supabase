...
## Décisions complémentaires consolidées

### Convention avant configuration

GeeCole fournit des catalogues de référence. L’établissement active ce dont il a besoin et applique une surcharge locale lorsqu’un libellé ou un paramètre doit différer.

### Historique non rétroactif

Une donnée déjà utilisée par une évaluation, une note, un bulletin, une inscription ou un encaissement ne doit pas être réécrite rétroactivement. Une nouvelle version ou une nouvelle tranche est créée.

### Paramétrage cohérent front et back

Une fonctionnalité désactivée est masquée dans l’interface et refusée par les services backend. Les validations, imports, exports et autorisations s’adaptent à la même configuration.
